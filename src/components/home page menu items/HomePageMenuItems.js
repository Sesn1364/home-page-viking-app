...
const HomePageMenuItems = () => {
    ...
    return (
       <div className="flex flex-wrap pt-6">
        {menuItems.map((item) => {
            return (
                <div key={item.id} className="w-4/12 flex justify-center items-center mb-4">
                    <button className="w-24 h-24 py-2 bg-gray-400 rounded-2xl text-center text-xs text-white bg-gray-300 bg-opacity-30 shadow-2xl">
